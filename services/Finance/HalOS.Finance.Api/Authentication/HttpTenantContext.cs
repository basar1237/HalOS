...
/// Sales/Party deseniyle birebir. Consumer scope'unda tenant mesajdan (AmbientTenantContext)
/// çözülür; API kompozisyonunda ITenantContext CompositeTenantContext'e bağlanır (Program.cs).
/// </summary>
