namespace HalOS.Finance.Domain.ValueObjects;
...
/// (<see cref="MidpointRounding.ToEven"/>) ile yapılır. Cari bakiye Σ hareket ile türetilir; her
/// hareket zaten kuruşa yuvarlı tutulur, toplam da kuruşa normalize edilir. Kural tek noktada
/// toplanır ki tüm servis aynı yuvarlamayı kullansın (Sales.Money deseniyle birebir — docs/07 §10).
/// </summary>
