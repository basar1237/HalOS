...
/// <summary>
/// İsteğin tenant'ını JWT tenant claim'inden çözer (docs/04 §7, docs/07 §6). Arama uçları bu değeri
/// kullanarak sonucu SADECE JWT tenant'ına kısıtlar (BK-8, çapraz-tenant sızıntısı YASAK). Anonim
/// isteklerde tenant çözülmez (HasTenant = false).
/// </summary>
