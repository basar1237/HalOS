...
/// <see cref="Result"/> ile taşınır (bkz. <see cref="ApiResults"/>); buraya yalnızca
/// gerçekten istisnai durumlar düşer. İç ayrıntı (exception mesajı/stack) istemciye sızmaz.
/// </summary>
