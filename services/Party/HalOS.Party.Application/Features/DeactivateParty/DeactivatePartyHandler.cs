...
internal sealed class DeactivatePartyHandler : ICommandHandler<DeactivatePartyCommand>
{
    private readonly IPartyRepository _parties;
    private readonly IUnitOfWork _unitOfWork;

    public DeactivatePartyHandler(IPartyRepository parties, IUnitOfWork unitOfWork)
    {
        _parties = parties;
        _unitOfWork = unitOfWork;
    }

    public async Task<Result> Handle(DeactivatePartyCommand request, CancellationToken cancellationToken)
    {
