...
/// e-MM sandbox entegrasyonu SONRAKİ slice'ta gelir; şu an dış G/Ç yapılmaz, sahte ama benzersiz bir
/// makbuz numarası üretilip başarı döndürülür. Böylece e-MM akışı (SaleCompleted → belge → outbox
/// event) uçtan uca çalışır ve gerçek entegrasyonda yalnız bu adaptör değiştirilir (bağımlılığın
/// tersine çevrilmesi — Application soyutlamaya bağlıdır, uygulamaya değil).
///
