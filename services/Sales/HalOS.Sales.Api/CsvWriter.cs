...
/// — böylece dosya, ondalık ayıracı virgül olan Türkçe kültürde bile tutarlı üretilir. Bu yardımcı
/// yalnız Sales Api sunum katmanına aittir; Application query'leri değişmez.
/// </summary>
public static class CsvWriter
{
    ...
    /// <summary>
    /// Başlık + satırlardan UTF-8 CSV metni üretir. <paramref name="rows"/> her biri hücre dizisi.
    /// Hücreler zaten string; sayı/tarih çağıran tarafça InvariantCulture ile biçimlenmelidir.
    /// </summary>
